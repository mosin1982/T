...
def test_run_backtest_generates_enhanced_analytics(tmp_path: Path):
    ...
    csv_path.write_text(
        "\n".join(
            [
                "asset,volume,price_change_pct,liquidity_score,risk_score,entry_price,exit_price",
                "BTC/USDT,100,100,100,100,100,101",
                "BTC/USDT,110,100,100,100,100,102",
                "BTC/USDT,120,100,100,100,100,100,103",
                "BTC/USDT,130,100,100,100,100,104",
                "BTC/USDT,10000,100,100,100,100,120",
            ]
        ),
        encoding="utf-8",
    )
